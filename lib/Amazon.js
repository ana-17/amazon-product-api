...
class AmazonScraper {
    ...
    httpRequest({ uri, method, qs, json, body, form }) {
        ...
        console.log('URI:', uri);
        console.log("mainhost: ", this.mainHost);
        console.log("geo.host: ", this.geo.host);
    ...
    grabReviews(body) {
         ...
         */
        this.reviewMetadata.total_reviews = parseInt($('.averageStarRatingNumerical').text().replace(/,/g, ''), 10);
        console.log("this.reviewMetadata.total_reviews ", this.reviewMetadata.total_reviews);
        const reviewsList = $('#cm_cr-review_list')[0].children;
        console.log("reviewslist ", reviewsList.length);
        let scrapingResult = {};
        ...
        console.log("total_reviews ", this.reviewMetadata.total_reviews);
        /**
         * Review date
         */
        ...
        //ADD HERE- GET REVIEWER AMAZON ID
        ...
        console.log("scrapingresult2 ", scrapingResult);
        for (let key in scrapingResult) {
